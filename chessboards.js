class ChessboardBlockedSpaces {
    constructor() {
        ...
        this.data = [
            ...
            { date: "2024-09-30", locations: [ "B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "C1", "C2", "C3", "C4", "C5", "C6", "C7", "C8", "D1", "D2", "D3", "D4", "D5", "E1", "E2", "F1", "F2", "G1", "G2", "G3", "G4" ] },
            { date: "2024-10-01", locations: [ "A2", "A3", "A4", "A5", "A6", "B3", "B4", "B5", "B6", "B7", "C1", "C2", "C3", "C4", "C5", "C6", "D1", "D2", "D3", "D4", "D5", "E1", "E2", "F1", "F2", "G1", "G2", "G3", "G4", "G5", "H1" ] },
            { date: "2024-10-02", locations: [ "B2", "B3", "B4", "B5", "B6", "B7", "C1", "C2", "C3", "C4", "D2", "D3", "D4", "D5", "D6", "E1", "E2", "F1", "F2", "G1", "G2", "H2", "H3", "H4" ] },
            { date: "2024-10-03", locations: [ "B1", "B2", "B3", "C1", "C2", "C3", "D1", "D2", "D3", "D4", "E1", "E2", "F1", "F2", "F3", "G1", "G2", "H2", "H3", "H4", "H5" ] },
            { date: "2024-10-04", locations: [ "A3", "A4", "A5", "B2", "B3", "B4", "C2", "C3", "C4", "D1", "D2", "D3", "D4", "E2", "E3", "F1", "F2", "F3", "G1", "G2", "H2" ] },
            { date: "2024-10-05", locations: [ "B1", "B2", "B3", "B4", "C1", "C2", "C3", "D1", "D2", "D3", "E1", "E2", "F1", "F2", "F3", "G1", "G2", "G3", "H1", "H2" ] },
            { date: "2024-10-06", locations: [ "A2", "A3", "A4", "B3", "B4", "B5", "C2", "C3", "C4", "D2", "D3", "D4", "E1", "E2", "F1", "F2", "G1", "G2", "H2", "H3" ] },
            { date: "2024-10-07", locations: [ "A3", "A4", "A5", "A6", "B1", "B2", "C1", "C2", "C3", "D2", "D3", "D4", "E2", "F1", "F2", "G1", "G2", "H2", "H3" ] },
            { date: "2024-10-08", locations: [ "B1", "B2", "B3", "B4", "C1", "C2", "C3", "D1", "D2", "D3", "E1", "E2", "F1", "F2", "G1", "G2", "H2", "H3" ] },
            { date: "2024-10-09", locations: [ "A2", "A3", "A4", "B3", "B4", "B5", "C1", "C2", "C3", "D2", "D3", "D4", "E2", "F1", "F2", "G1", "G2", "H2", "H3", "H4" ] },
            { date: "2024-10-10", locations: [ "A2", "A3", "A4", "A5", "B1", "B2", "B3", "B4", "C1", "C2", "D1", "D2", "D3", "E1", "F1", "F2", "G1", "G2", "H1", "H2" ] },
            { date: "2024-10-11", locations: [ "A4", "A5", "A6", "B1", "B2", "B3", "C1", "C2", "C3", "D1", "D2", "D3", "E1", "F1", "F2", "F3", "G1", "H1", "H2", "H3" ] },
            { date: "2024-10-12", locations: [ "A3", "A4", "A5", "B1", "B2", "B3", "C1", "C2", "C3", "D1", "D2", "D3", "E1", "F1", "F2", "F3", "G1", "H2" ] },
            { date: "2024-10-13", locations: [ "A1", "A3", "A4", "A5", "B3", "B4", "B5", "C1", "C2", "C3", "D2", "D3", "D4", "E1", "F1", "F2", "G1", "H1", "H2" ] },
