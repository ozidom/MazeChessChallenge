class ChessboardBlockedSpaces {
    constructor() {
        ...
        this.data = [
            ...
            {"date": "2026-09-15", "gold": [ "A8", "B8", "D8", "F7", "C6", "G5", "B4", "F3", "C2", "C1", "G1" ], "guard": [ "♚D7", "♚E7", "♚D6", "♝F6", "♚G6", "♚H6", "♚B5", "♚C5", "♝E5", "♚H5", "♚C4", "♝D4", "♚E4", "♚F4", "♝E3", "♚D2", "♚F2", "♚G2", "♚D1", "♚F1" ], "locations": [ "B7", "C7", "B6", "H2", "H1" ] },
            {"date": "2026-09-16", "gold": [ "E8", "F8", "F7", "G7", "G6", "G5", "H4", "D3", "E3", "G3", "E2", "E1" ], "guard": [ "♞D7", "♞C5", "♝A4", "♝B4", "♝D4", "♞E4", "♝A3", "♝B3", "♞H3", "♜B2", "♝F2", "♜B1" ], "locations": [ "A8", "B8", "A7", "B7", "A6", "B6", "C6", "D6", "E6", "F6", "F5", "C4", "G4", "C3", "C2", "G2", "H2", "C1", "G1", "H1" ] },
            {"date": "2026-09-17", "gold": [ "D8", "E8", "B7", "C7", "F7", "A6", "E6", "A5", "G5", "B4", "E4", "F4", "A3", "D3", "F3", "C2", "G2", "B1", "H1" ], "guard": [ "♞D7", "♞B6", "♞E5", "♞C4", "♞E3", "♞G3", "♚A2", "♚B2" ], "locations": [ "A8", "B8", "C8", "A7", "C6", "D6", "C5", "D5" ] },
            {"date": "2026-09-18", "gold": [ "D8", "A5", "H4", "C3" ], "guard": [ "♞C8", "♞E8", "♝F8", "♝C7", "♝G7", "♞A6", "♞E6", "♞B5", "♚H5", "♚A4", "♚C4", "♚G4", "♚C2", "♚E2", "♚D1", "♝E1" ], "locations": [ "A8", "B8", "A7", "B7", "D5", "E5", "F5", "D4", "E4", "F4", "D3", "E3", "F3", "G2", "H2", "G1", "H1" ] },
            {"date": "2026-09-19", "gold": [ "B8", "C8", "D7", "A6", "C6", "G6", "H6", "C5", "E5", "D4", "H4", "B3", "F3", "C2", "G2" ], "guard": [ "♝B7", "♝C7", "♝E7", "♚F7", "♚G7", "♚B5", "♝F5", "♜G5", "♚H5", "♚B4", "♝C4", "♝C3", "♝D3", "♝E3", "♚H3", "♜F2" ], "locations": [ "A8", "A7", "H2", "G1", "H1" ] },
            {"date": "2026-09-20", "gold": [ "A7", "F7", "F6", "G6", "G5", "H5", "A3", "D3", "G3", "H3", "B2", "F2", "D1", "E1" ], "guard": [ "♞E8", "♞B6", "♞B5", "♞F5", "♞B4", "♞C4", "♞E4", "♞F4", "♞D2", "♞E2" ], "locations": [ "A8", "B8", "C8", "D8", "D6", "E6", "D5", "E5", "G2", "H2", "G1", "H1" ] },
            {"date": "2026-09-21", "gold": [ "D8", "B7", "F7", "G7", "G6", "C5", "F5", "G5", "F4", "B3", "E3", "F3", "E1" ], "guard": [ "♜C8", "♝D7", "♜B6", "♜C6", "♜F6", "♝A5", "♚D5", "♚E5", "♚D4", "♚E4", "♝G4", "♜C3", "♜G3", "♝F2" ], "locations": [ "A8", "B8", "A7", "A4", "B4", "C4", "A3", "D3", "B2", "D2", "G2", "H2", "C1", "D1", "G1", "H1" ] },
            {"date": "2026-09-22", "gold": [ "A8", "C8", "G8", "E7", "H7", "A6", "C6", "G6", "H6", "F5", "H5", "A4", "C4", "G3", "C1", "F1" ], "guard": [ "♝D7", "♞F7", "♞G7", "♝D6", "♝E6", "♞D5", "♞D4", "♞E4", "♝G4", "♝H4", "♚B3", "♝H3", "♚B2", "♚D2", "♚D1" ], "locations": [ "G2", "H2", "G1", "H1" ] },
            {"date": "2026-09-23", "gold": [ "C8", "F8", "B7", "D7", "E7", "G7", "B4", "F4", "H4", "E1" ], "guard": [ "♜C7", "♜F7", "♞A6", "♚C6", "♚D6", "♚E6", "♞G6", "♜C5", "♞D5", "♚E5", "♜D4", "♝G4", "♝A3", "♚C3", "♚D3", "♚F3", "♜H3", "♝B2", "♞C2", "♚D2", "♞G2", "♝C1" ], "locations": [ "A8", "B8", "A7", "H2", "G1", "H1" ] },
            {"date": "2026-09-24", "gold": [ "A8", "G1" ], "guard": [ "♞E7", "♞B6", "♝F6", "♞G6", "♞C5", "♞F5", "♝D4", "♞E4", "♞G4", "♝H4", "♝D3", "♞E3", "♝B2", "♝C2" ], "locations": [ "B8", "C8", "A7", "B7", "C7", "D6", "E6", "D5", "E5", "B4", "C4", "B3", "C3", "D2", "F2", "G2", "H2", "D1", "E1", "F1", "H1" ] },
            {"date": "2026-09-25", "gold": [ "B8", "A6", "C6", "B5", "C4", "E4", "A3", "D3", "F3", "B2", "E2", "C1", "F1" ], "guard": [ "♚C8", "♞F8", "♚B7", "♚C7", "♞D7", "♞F7", "♚G7", "♞E6", "♚G6", "♜C5", "♚D5", "♚E5", "♞G5", "♚F4", "♚G4", "♚G3", "♜F2" ], "locations": [ "A8", "A7", "G2", "H2", "G1", "H1" ] },
            {"date": "2026-09-26", "gold": [ "A8", "B8", "D8", "F8", "A7", "B7", "D7", "F7", "G6", "E5", "H4", "C3", "G2", "H2", "G1", "H1" ], "guard": [ "♚C8", "♜E8", "♜E7", "♝C6", "♜E6", "♚F5", "♜G5", "♜A4", "♜B4", "♜C4", "♝E4", "♚A3", "♚B3", "♚H3", "♚D2", "♚D1" ], "locations": [ "A6", "A5", "B5", "E2", "E1", "F1" ] }
        ]}
