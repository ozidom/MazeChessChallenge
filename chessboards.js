class ChessboardBlockedSpaces {
    constructor() {
        ...
        this.data = [
            ...
            { date: "2024-10-14", locations: [ "A8", "B8", "C8", "D8", "E8", "F8", "A7", "C7", "D7", "F7", "A6", "B6", "D6", "E6", "F6", "A5", "C5", "D5", "E5", "G5", "B4", "C4", "D4", "A3", "C3", "D3", "E3", "A2", "C2", "E2", "F2", "G2", "H2", "B1", "C1", "D1", "E1", "F1", "G1" ]},
            { date: "2024-10-15", locations: ["B7", "C7", "D7", "E7", "F7", "B6", "C6", "D6", "E6", "F6", "G6", "A5", "G5", "H5", "A4", "B4", "C4", "D4", "F4", "A3", "B3", "C3", "D3", "F3", "G3", "A2", "F2", "G2", "H2", "B1", "C1", "D1", "E1", "H1"]},
