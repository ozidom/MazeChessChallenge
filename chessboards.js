class ChessboardBlockedSpaces {
    constructor() {
        ...
        this.data = [
            ...
            { "date": "2024-11-04", "gold": [ "A8", "D8", "D2", "H1" ], "locations": [ "B8", "C8", "B7", "E7", "F7", "G7", "A6", "C6", "D6", "F6", "G6", "A5", "C5", "D5", "F5", "G5", "H5", "A4", "D4", "G4", "B3", "E3", "G3", "B2", "C2", "H2", "C1", "E1", "F1" ] },
            { "date": "2024-11-05", "gold": [ "A8", "D8", "H5", "D2", "H1" ], "locations": [ "B8", "C8", "B7", "D7", "E7", "F7", "G7", "H7", "A6", "C6", "D6", "F6", "G6", "H6", "A5", "C5", "F5", "G5", "A4", "D4", "F4", "G4", "H4", "B3", "C3", "E3", "H3", "B2", "C2", "E2", "F2", "H2" ] },
            { "date": "2024-11-06", "gold": [ "B5", "H4", "H1" ], "locations": [ "B7", "C7", "D7", "A6", "B6", "D6", "E6", "F6", "G6", "A5", "C5", "D5", "H5", "A4", "B4", "C4", "D4", "D3", "E3", "G3", "H3", "B2", "H2", "D1" ] }]
        }
