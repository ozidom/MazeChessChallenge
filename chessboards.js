class ChessboardBlockedSpaces {
    constructor() {
        ...
        this.data = [
            ...
            { date: "2024-10-15", gold :[], locations: ["B7", "C7", "D7", "E7", "F7", "B6", "C6", "D6", "E6", "F6", "G6", "A5", "G5", "H5", "A4", "B4", "C4", "D4", "F4", "A3", "B3", "C3", "D3", "F3", "G3", "A2", "F2", "G2", "H2", "B1", "C1", "D1", "E1", "H1"]},
            ...
            { date: "2024-10-17", gold :["C8","E8","G1"], locations: ["D8", "B7", "C7", "D7", "E7", "F7", "E6", "B5", "C5", "F5", "A4", "B4", "C4", "E4", "G4", "A3", "C3", "E3", "F3", "H3", "A2", "D2", "F2", "G2", "B1", "C1", "D1", "E1", "F1", "H1" ] },
