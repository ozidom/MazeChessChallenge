class ChessboardBlockedSpaces {
    constructor() {
        ...
        this.data = [
            ...
            { "date": "2024-10-18", "gold" :["C8","E8","G1"], "enemies": ["BE5", "NG7"],"locations": ["D8", "B7", "C7", "D7", "E7", "F7", "E6", "B5", "C5", "F5", "A4", "B4", "C4", "E4", "G4", "A3", "C3", "E3", "F3", "H3", "A2", "D2", "F2", "G2", "B1", "C1", "D1", "E1", "F1", "H1" ] },
            { "date": "2024-10-19", "gold" :["C8","E8","G1"],  "enemies": ["NE5", "NG7"],"locations": ["D8", "B7", "C7", "D7", "E7", "F7", "E6", "B5", "C5", "F5", "A4", "B4", "C4", "E4", "G4", "A3", "C3", "E3", "F3", "H3", "A2", "D2", "F2", "G2", "B1", "C1", "D1", "E1", "F1", "H1" ] },
            { "date": "2024-10-20", "gold" :["C8","E8","G1"],  "enemies": ["BE5", "NG7"],"locations": ["D8", "B7", "C7", "D7", "E7", "F7", "E6", "B5", "C5", "F5", "A4", "B4", "C4", "E4", "G4", "A3", "C3", "E3", "F3", "H3", "A2", "D2", "F2", "G2", "B1", "C1", "D1", "E1", "F1", "H1" ] },
            { "date": "2024-10-21", "gold" :["C8","E8","G1"],  "enemies": ["BE5", "NG7"],"locations": ["D8", "B7", "C7", "D7", "E7", "F7", "E6", "B5", "C5", "F5", "A4", "B4", "C4", "E4", "G4", "A3", "C3", "E3", "F3", "H3", "A2", "D2", "F2", "G2", "B1", "C1", "D1", "E1", "F1", "H1" ] }  
        ]
    }
