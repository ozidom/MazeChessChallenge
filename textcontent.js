/*const GAME_TEXT = "<p>Click START. Choose ♚ ♝ ♜ or ♞. Move from the bottom left to the top right in the fewest moves. Cannot move on blocked squares but Knights can jump over them. Switch piece for 1 move.</p>";
